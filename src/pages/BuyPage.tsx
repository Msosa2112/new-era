        ...
        <div className="container" style={{ position: 'relative', zIndex: 1, maxWidth: '880px' }}>
          ...
          <p className="editorial-lead" style={{ color: 'var(--text-secondary)' }}>
            {lang === 'es'
              ...
              : 'Acquiring a residence in Greater Louisville and Kentucky requires architectural clarity, market foresight, and uncompromising client advocacy.'}
          </p>
          ...
          <div style={{ display: 'flex', gap: '1rem', marginTop: '2rem', flexWrap: 'wrap' }}>
            ...
            <button onClick={onOpenConsultation} className="btn-outline">
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div
            style={{
              ...
              border: '1px solid rgba(102, 14, 26, 0.16)',
              display: 'grid',
          ...
          >
            <HexPattern variant="burgundy" opacity={0.06} maskFade="radial-top-right" />
            <div style={{ position: 'relative', zIndex: 1 }}>
              <span className="display-subtitle" style={{ color: 'var(--color-burgundy-primary)' }}>
                {lang === 'es' ? 'PROGRAMAS ESPECIALES' : 'SPECIAL FINANCING'}
              </span>
              <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: '2rem', color: 'var(--text-primary)', marginTop: '0.5rem', marginBottom: '0.75rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', position: 'relative', zIndex: 1 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
                <CheckCircle2 size={18} color="var(--color-burgundy-primary)" />
